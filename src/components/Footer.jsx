...
const PAYMENT_METHODS = ['Paystack', 'Verve', 'Mastercard', 'Visa', 'Bank Transfer'];
    ...
    <footer className="footer">
      <div className="footer__newsletter">
        <div className="footer__newsletter-copy">
          <h2 className="footer__newsletter-heading">Join the Omoteeluxe&nbsp;&nbsp; family</h2>
          <p className="footer__newsletter-subtext">
            New drops, restocks, and behind-the-hook stories — straight to your inbox, once in a while.
          </p>
        </div>
        ...
        {subscribeError && (
          <p className="footer__newsletter-error" role="alert">{subscribeError}</p>
        )}
        
        {subscribed && (
          <p className="footer__newsletter-confirm">✅ You're on the list — welcome!</p>
        )}
      </div>
      ...
      <div className="footer__main">
        <div className="footer__brand">
          ...
          <p className="footer__brand-copy">
           OmoteeLuxe: Nigerian Craft, Global Luxury.
          </p>
          <div className="footer__socials">
            <a href="https://www.instagram.com/shopteeluxe?igsh=YWo5NGE3dHhkejNm&utm_source=qr" aria-label="Instagram" className="footer__social-icon">
              <InstagramIcon />
            </a>
            <a href="https://www.tiktok.com/@shopteeluxee?_r=1&_t=ZN-969uRwQB9fy" aria-label="TikTok" className="footer__social-icon">
              <TikTokIcon />
            </a>
            <a href="https://wa.me/2347048304972" aria-label="WhatsApp" className="footer__social-icon">
              <WhatsAppIcon />
            </a>
          </div>
        </div>
          ...
          <div className="footer__group" key={group.heading}>
            ...
            <ul className="footer__group-links">
              {group.links.map((link) => {
                ...
                const linkPath = isObject ? link.path : `#${linkName.toLowerCase().replace(/\s+/g, '-')}`;
        ...
        <div className="footer__group footer__group--contact">
          ...
          <a href="mailto:shopteeluxee@gmail.com" className="footer__contact-link">
            shopteeluxee@gmail.com <ArrowUpRightIcon />
          </a>
          <a href="tel:+2347048304972" className="footer__contact-link">
            +234 704 830 4972 <ArrowUpRightIcon />
          </a>
        </div>
      </div>
      ...
      <div className="footer__bottom">
        <p className="footer__copyright">© {new Date().getFullYear()} Omoteeluxe. All rights reserved.</p>
